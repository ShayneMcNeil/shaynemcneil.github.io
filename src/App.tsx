...
const Contact = () => (
  <div className="flex flex-col items-center justify-center p-8 md:p-16 min-h-[60vh] text-center max-w-3xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full">
       <a href="mailto:mr.amero081494@gmail.com" className="flex flex-col items-center justify-center gap-4 p-8 bg-white dark:bg-gray-900 backdrop-blur-md border border-gray-200/50 dark:border-gray-700/50 rounded-2xl hover:border-yellow-400 dark:hover:border-yellow-500 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
          <div className="p-4 bg-yellow-100 dark:bg-gray-800 text-yellow-700 dark:text-yellow-400 rounded-full group-hover:bg-yellow-400 dark:group-hover:bg-yellow-500 group-hover:text-gray-900 transition-colors">
            <Mail size={28} />
          </div>
          <span className="font-semibold text-gray-900 dark:text-gray-100 text-lg">Email Me</span>
       </a>
